// app/api/business-permit/[id]/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.log('Fetching business permit by ID:', {
      id,
      url: `${LARAVEL_API_URL}/business-permit/${id}`,
      hasAuth: !!token,
    })
...
export async function PATCH(
  ...
  try {
    ...
    console.log('Updating business permit status:', {
      id,
      url: `${LARAVEL_API_URL}/business-permit/${id}/status`,
      hasAuth: !!token,
      bodyKeys: Object.keys(body),
    })

    const response = await fetch(`${LARAVEL_API_URL}/business-permit/${id}/status`, {
      method: 'PATCH',
      headers: {
