...
import { ArrowLeft, FileText, CheckCircle, Clock, XCircle, Eye, Search, Calendar, User, Hash, BarChart3, RefreshCw, Activity, Heart, Shield, Building, Users, Home, Baby, FileHeart } from "lucide-react"
...
export default function ApplicationsPage() {
  ...
  try {
    // Single unified call to /api/applications which now includes everything
    ...
    // Handle the unified response from /api/applications
                              ...
                              <dd className="text-sm text-gray-900 flex-1 break-words">
                                {(() => {
                                  ...
                                  if (value && typeof value === 'string') {
                                    // Check if it matches ISO date format or common date patterns
